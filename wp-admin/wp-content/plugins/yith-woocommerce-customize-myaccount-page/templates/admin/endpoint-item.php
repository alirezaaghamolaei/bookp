            ...
            <tbody>
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Add additional classes to endpoint container.', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
