            ...
            <table class="options-table form-table">
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Group icon for "My Account" menu option', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Add additional classes to group container.', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
