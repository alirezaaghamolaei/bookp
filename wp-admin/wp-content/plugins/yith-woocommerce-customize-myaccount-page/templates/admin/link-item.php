            ...
            <tbody>
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'The url of the menu item.', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Menu label for this link in "My Account".',
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Link icon for "My Account" menu option', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
                ...
                <tr>
                    <th>
                        ...
                        <img class="help_tip" data-tip='<?php _e( 'Add additional classes to link container.', 'yith-woocommerce-customize-myaccount-page' ) ?>' src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" height="16" width="16" />
                    </th>
                    <td>
