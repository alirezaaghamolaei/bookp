...
if(!is_product()):
	...
	if(emallshop_get_option('shop-page-layout', 'left') =="full-layout"):
		$classes[] = 'col-xs-6 col-sm-4 col-md-3 col-lg-' . $grid_column;
	else:
		$classes[] = 'col-xs-6 col-sm-6 col-md-4 col-lg-' . $grid_column;
	endif;
endif;

$id = get_the_ID();
?>
<li <?php wc_product_class( $classes ); ?> data-postID="post-<?php echo esc_attr($id);?>">
