 ...
 */
require_once EMALLSHOP_LIB . '/classes/class-tgm-plugin-activation.php';
...
function emallshop_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/emallshop/pl-emallshop-extensions-1.1.5.zip'), // The plugin source.
			'version'  				=> '1.1.6',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'js_composer',
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/js_composer.zip'), // The plugin source.
			'version'  				=> '5.4.5',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'revslider',
			'source'             	=> esc_url('http://demo.presslayouts.com/plugins/revslider.zip'), // The plugin source.
			'version'  				=> '5.4.6.3',
			'required' 				=> true,
		),
		array(
